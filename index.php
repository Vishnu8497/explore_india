        ...
        <ul class="slides">
            <li>
                ...
                <div class="caption left-align">
                    <h3>Travel is a way to live your life to the fullest.</h3>
                </div>
            </li>
            <li>
                <img src="images/slide3.jpg">
                <div class="caption right-align">
                    <h3>The world is open for us to travel and explore.</h3>
                </div>
            </li>
            <li>
                <img src="images/slide4.jpg">
                <div class="caption center-align">
                    <h3>Don’t just read about a place, visit it instead.</h3>
                </div>
            </li>
        </ul>
    </div>
