    ...
    <div class="row">
        <div class="col s12 m6 l6">
            <div class="row">
                ...
                <div class="col s9">
                    <span style="position:relative;top:24px;font-size:17px;">+91-9167090290</span><br>
                    <span style="position:relative;top:24px;font-size:17px;">+91-9967171918</span>
                </div>
            </div>
            <div class="row">
                <div class="col s2"></div>
                ...
                <div class="col s8">
                    <span style="position:relative;top:28px;font-size:17px;">vishnupillai804@gmail.com</span>
                </div>
            </div>
        </div>
